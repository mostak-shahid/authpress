...
class LogsController
{
    ...
    {
        global $wpdb;
        $this->logs_table_name = $wpdb->prefix . 'authpress_logs';
    }

	public static function log_settings_reset($section, $old_data, $new_data)
	{
		global $wpdb;
		$logs_table_name = $wpdb->prefix . 'authpress_logs';
		...
		$wpdb->insert(
			...
			[
                ...
                'category' => __('Settings Reset', 'authpress'),
	...
	public static function log_settings_change($old_data, $new_data)
	{
		...
		$wpdb->insert(
			...
			[
                ...
                'category' => __('Settings Change', 'authpress'),
