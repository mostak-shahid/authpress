 ...
 * Plugin URI:        https://mostak-shahid.github.io/plugins/authpress.html
 * Description:       AuthPress is a powerful WordPress Login Page Customizer that lets you fully redesign the wp-login page, register form, and forgot password screen while enhancing security and user experience.
 * Version:           1.0.0
...
define('AUTHPRESS_MAIN_FILE', __FILE__);

require_once AUTHPRESS_PATH . '/vendor/autoload.php';
require_once AUTHPRESS_PATH . '/authpress-functions.php';
...
if ( defined( 'WP_CLI' ) && WP_CLI && file_exists( plugin_dir_path( __FILE__ ) . 'includes/CLI/CLI_Command.php' ) ) {
    ...
    if ( file_exists( $cli_file ) ) {
        WP_CLI::add_command( 'authpress', 'MosPress\Authpress\CLI\CLI_Command' );
    }
}
