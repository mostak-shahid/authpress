        ...
        <div className={`box-shadow-wrapper ${className}`}>
            <Space align='center'>
                ...
                <Typography.Title heading={6} style={{ margin: 8 }}>
                    {shadow.enabled ? __('Enabled', 'authpress') : __('Disabled', 'authpress')}
                </Typography.Title>
            </Space>
            {shadow.enabled && (
                <Space vertical align='start' className='w-full'>
                    ...
                    /> 
                    <div>
                        <label className='font-semibold block mb-1'><Typography.Text>{__('Inset', 'authpress')}</Typography.Text></label>
                        <Switch 
