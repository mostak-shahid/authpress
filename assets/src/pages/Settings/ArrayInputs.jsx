                            ...
                            </Col>    
                            {
                                ...
                                <Col xs={24} lg={12} xl={10}>
                                    <Form.CheckboxGroup field="checkbox" noLabel direction="vertical">
                                        <Form.Checkbox value="checkbox-1">{__('Checkbox 1', 'authpress')}</Form.Checkbox>
                                        <Form.Checkbox value="checkbox-2">{__('Checkbox 2', 'authpress')}</Form.Checkbox>
                                        <Form.Checkbox value="checkbox-3">{__('Checkbox 3', 'authpress')}</Form.Checkbox>
                                        <Form.Checkbox value="checkbox-4">{__('Checkbox 4', 'authpress')}</Form.Checkbox>
                                    </Form.CheckboxGroup>
                                </Col>
                            }
                        </Row>
