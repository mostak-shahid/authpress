    ...
    return (
        <>
            {/* <div className="top-bar bd-gray-800 text-white py-2">
                <div className="text-center">{__( `Unlock ${Details?.name}'s Full Potential!Get exclusive features and unbeatable performance.Upgrade now`, "authpress" )}</div>
            </div> */}
                    ...
                    <Navbar.Collapse id="basic-navbar-nav">
                        ...
                        {/* <Nav className="navbar-nav-left navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <Nav.Link as={NavLink} to="/explore" end onClick={handleNavClick}>
                                {__( 'Explore', "authpress" )}
                            </Nav.Link>
                            <Nav.Link as={NavLink} to="/settings" onClick={handleNavClick}>
                                {__( 'Settings', "authpress" )}
                            </Nav.Link>
                            <div className="d-block d-lg-none">
                            <NavDropdown title="Settings">
                                <li><Link to="/settings/buy_together" className="dropdown-item" onClick={handleNavClick}>{__( 'Buy Together', "authpress" )}</Link></li>
                                <li><Link to="/settings/product_addons" className="dropdown-item" onClick={handleNavClick}>{__( 'Product Addons', "authpress" )}</Link></li>
                                <li><Link to="/settings/product_badge" className="dropdown-item" onClick={handleNavClick}>{__( 'Product Badge', "authpress" )}</Link></li>
                            </NavDropdown>
                            </div>
                        </Nav> */}
            ...
            <Offcanvas show={show} onHide={handleClose} placement="end">
                ...
                <Offcanvas.Title>{__( 'What\'s New', "authpress" )}</Offcanvas.Title>
                </Offcanvas.Header>
                <Offcanvas.Body>
                <p>{__( 'Loading...', "authpress" )}</p>
